...
**Answer** There are slightly differently spelled or punctuated versions of the same recipient name. For instance, the first page of results lists "W. MILLAR & CO" and "W. MILLAR & CO." separately. The same goes for Walter's Sports Bar and Restaurant, which is spelled four different ways on the first page of results.
...
**Answer** refinr changed "JOE'S SEAFOOD PRIME STEAK & STONE CRAB" to "JOE'S SEAFOOD, PRIME STEAK & STONE CRAB," adding a comma. On the second page, refinr changed "LE DIPLOMATE, LE DIPLOMATE" to "LE DIPLOMATE."
...
**Answer** It changed the "W. MILLAR & CO" entry to "W. MILLAR & CO." with a period at the end. It changed "PIZZA, WE THE" to "WE THE PIZZA."
...
**Answer** The changes made by n_gram_merge() do not vary substantially from the previous use of key_collision_merge. The only different I see is that while key_collision_merge did not change "WALTERS SPORTS" to "WALTERS SPORT," n_gram_merge() did. So in this case, n_gram_merge() did a slightly better job cleaning up the recipient_clean field.
