...
https://datawrapper.dwcdn.net/PfF0Q/1/
...
Now the map only shows Maryland's counties, rather than every county in the U.S. The counties appear in various hues of blue and green, with counties where Wes Moore got more votes shaded darker blue and counties where Dan Cox got more votes shaded lighter green.
...
**Answer** Describe the changes from the previous map
When I hover over a county on the map, I now see the name of the county instead of the FIPS code and the percent votes for Moore rounded to the nearest tenth rather than a very long decimal.
...
https://datawrapper.dwcdn.net/K6GtD/1/