...
```{r echo=FALSE}
census_api_key("93bf0ec60a49986ed43f998326ffa4758f34cccf", overwrite=TRUE)
```
...
**Answer**
Nevada had the largest percent change in population between the 2000 and 2010 censuses, at 35.1%.
...
**Answer** Howard County had the highest median household income in 2020, according to the ACS 5-year data: $124,042.
...
**Answer** No, because the bars overlap.

Is the difference between Howard and everyone else significant?
**Answer** Yes. Howard County household incomes are significantly higher than in the rest of the state. The bars are far from overlapping with those for Calvert or Montgomery Counties.
...
**Answer** 
No county saw their median income fall from 2010 to 2020 according to the estimate figures. But, given that the minimum value of the 2020 estimate for Caroline County was less than the minimum value of the 2018 estimate, it is possible that Caroline County's median household income actually decreased between 2010 and 2020.
...
**Answer** Of the 20 zip codes with the largest total contribution amounts, only 21202 has an estimated median household income less than $50,000, at $45,865. This zip code is located mostly in the city of Baltimore. Does this suggest that 21202 has a very high rate of economic inequality, with some wealthy people who make large political contributions and a lot of people who struggle economically?
...
**Answer** I wondered why the top-ranking zip code in terms of highest median household income donated so little - and also why it has such a large margin of error. Why do some zip codes have much larger margins of error than others? After looking up 21723, I found that it covers a small town in wealthy Howard County: Cooksville, which had a population of 631 in 2016 according to Wikipedia. 21071 covers Glyndon, Maryland in Baltimore County - evidently another wealthy small town.

If Howard County is Maryland's richest county, do Howard County zip codes dominate the list of counties with the largest total contributions? Are there any counties that are contributing more than their median incomes suggest they would?

If this tibble is allowing us to compare median incomes and total contributions by county for 2019, did the total contributions different counties gave in relation to their wealth change in later years?
