...
**Answer** There's a table, but the new registrations and removals are smooshed together in one table, and the column names are just V1, V2, etc. They don't describe the content of the table.
...
**Answer** Now we have a dataframe only showing the new registration data for each party by registration type. The datatypes have been fixed so that they are all <dbl>, except in the method column, the numbers don't have commas, and there are new month and year columns to show that this data is from October 2022. All the column names are correct.
...
**Task** Run the following code and describe the result.
**Answer** 
Now we have a dataframe only showing the number and method of registration removals by party. The datatypes have been changed to <dbl> (except in the method column), and the commas have been removed from the numbers. The rows with just NAs are gone, the column names are correct, and there are new month and year columns to show that the data is from October 2022.
```{r}
# make the new dataframe, renaming the columns and ditching the columns we don't want
...
**Answer** Unaffiliated voters were more likely to register at the MVA or other state agencies than by other means. They accounted for 32.0% of new registrations at the MVA in October 2022 and 31.4% of new registrations at other state agencies. Which state agencies (beside the MVA) were the most popular voter registration sites, and under what circumstances did these people register? According to this dataframe, 34.8% of voters who registered by "other means" registered unaffiliated. What are these other means?

Most of the new registrations by ERIC report (64.1%) and provisional ballot (63.4%) were Democrats. Is this a function of Democrats' youth and greater geographic mobility compared to Republicans and unaffiliated voters? 
...
**Task** Run the following code and describe what you think are the most interesting percentages in the dataframe.
**Answer**
60.9% of removals due to transferring to a different county were for Democrats. Does this support my earlier theory that Democrats are more likely to register by provisional ballot or ERIC report because they move around more (possibly also due to being younger)? That 54.6%  of Democrat removals were due to moving out of state also supports this theory.

It's striking that the highest percentage of voters removed from the rolls due to criminal conviction were unaffiliated by a significant margin were Democrats - 61.4% compared with 9.6% Republicans and 26.3% unaffiliated. Is this because the criminal justice system and incarceration disproportionately affect people of color, and the Democratic party in Maryland is more racially diverse?
...
**Answer** 
The combined dataframe has 16 rows, while the October and June dataframes have 17 rows.
```{r}
...
**Task** Run the following code. How many rows do you have compared to either the October or June dataframes?
**Answer** Now there are 17 rows in the combined dataframe, like in the June and October dataframes.
...
**Answer** 
Republican registrations as a result of volunteer efforts formed a much more significant percentage of all registrations through volunteer efforts in June, the monthly before primaries, than they did in October, the month before the general election, dropping by 12.7%. In contrast, Democratic registrations made up a much higher percentage of registration through volunteer efforts in October than in June, increasing by 19.2%. Did Republicans' showing in the primary make the Maryland Republican Party think it wasn't worthwhile to use volunteers to try and register people right before the general election?
Did the Republicans who got on the ticket for the November election discourage people from registering as Republican a month before the general election? Did that ticket - or the Democrats' ticket - galvanize people to register as Democrats when volunteers invited them to do so?

Also, Republicans did significantly (-8.7%) worse in ERIC report registrations in October than they did in June. Democrats and unaffiliated both did 4-5% better. ERIC report registrations have to do with when people move. Does this suggest that more Republicans moved in the first half of the year? 
```{r}
...
**Answer**Democratic voters seem to be more geographically mobile and more likely to either cast absentee ballots or register as a part of the moving process (i.e., through ERIC reporting). I suspect that Democrats' high representation in registration through provisional ballot also stems from their geographic mobility, as when people cast provisional ballots in their new jurisdictions while they are still registered elsewhere. Democratic voters are also more likely to register by mail.
...
**Answer** Provisional ballots were a more common method of registration for Democratic voters in June than in October - the most common in June and the fourth most common in October. Volunteer registrations were more common for Democrats in October than June, probably because volunteer efforts were stepped up in advance of the general election. I'm not sure why the ERIC report registrations ranked higher in October. Is there a particular seasonality to this kind of reporting?
